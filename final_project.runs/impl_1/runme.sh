...
HD_PWD='C:/Users/nucle/Downloads/final_project/final_project.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log wnmux.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source wnmux.tcl -notrace
