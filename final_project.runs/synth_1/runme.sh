...
HD_PWD='C:/Users/nucle/Downloads/final_project/final_project.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log wnmux.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source wnmux.tcl
